    ...
    return(
        <>
            <div className="inset-0 fixed bg-[#f4EAe0]/50 flex justify-center items-center w-full h-full opacity-90">
                <section className="bg-[#e8d8c4] w-[90%] h-auto flex flex-col justify-center rounded-lg gap-2 border-1 sm:w-[55%] sm:h-[65%]">
                    <div className="w-full flex flex-col  p-5 gap-3 sm:h-[70%] sm:p-8 sm:gap-4">
                        <span>{header}</span>
                    ...
                    <div className="w-full flex p-5 gap-4 sm:h-[30%] sm:p-8 sm:gap-8">
